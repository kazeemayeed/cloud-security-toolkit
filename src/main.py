...
@click.option('--format', '-f', type=click.Choice(['terraform', 'cloudformation', 'arm']),
              required=True, help='Infrastructure as Code format')
...
@click.option('--cloud', '-cl', type=click.Choice(['aws', 'azure', 'gcp', 'all']),
