...
class RuleEngine:
    ...
    def evaluate_rule(
        self, rule: Dict[str, Any], content: Dict[str, Any], file_path: Path
    ) -> List[Dict[str, Any]]:
    ...
    def filter_by_severity(
        self, findings: List[Dict[str, Any]], min_severity: str
    ) -> List[Dict[str, Any]]:
        ...
        return [
            ...
            if self.severity_weights.get(finding.get("severity", "medium"), 2)
            >= min_weight
        ]
